...
import (
	...
	grpc_server "exam_5/jobsService/internal/delivery/grpc/server"
	invest_grpc "exam_5/jobsService/internal/delivery/grpc/service"
	...
	repo "exam_5/jobsService/internal/infrastructure/repository/postgres"
	"exam_5/jobsService/internal/pkg/config"
	"exam_5/jobsService/internal/pkg/logger"
...
func (a *App) Run() error {
	...
	jobRepo := repo.NewJobRepo(a.DB)

	// usecase initialization
	jobUsecase := usecase.NewJobService(contextTimeout, jobRepo)

	pb.RegisterJobServiceServer(a.GrpcServer, invest_grpc.NewRPC(a.Logger, jobUsecase, serviceClients))
